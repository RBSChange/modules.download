<?php
/**
 * download_BlockAbstractDocumentcardListAction
 * @package modules.download.lib.blocks
 */
abstract class download_BlockAbstractDocumentcardListAction extends website_BlockAction
{
	/**
	 * @return array
	 */
	...
	public function execute($request, $response)
	{
		...
		if ($count > 0)
		{
			...
			$paginator = new paginator_Paginator('download', $page, $docs, $itemsPerPage);
	...
	{
		$bes = download_DocumentcardService::getInstance();
		$parentDoc = $this->getParentDoc($request);
