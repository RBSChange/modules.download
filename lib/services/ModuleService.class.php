...
class download_ModuleService extends ModuleBaseService
{
	...
	public function getStructureInitializationAttributes($container, $attributes, $script)
	{
		switch ($script)
		{
			...
			default:
				throw new BaseException('Unknown structure initialization script: '.$script, 'modules.download.bo.general.Unknown-structure-initialization-script', array('script' => $script));
		}
	}
